<?php
	...
	function captcha_check($registration_details){
		...
		if ($answer != $_SESSION['captcha_math_answer']){
			...
			$main_smarty->assign('register_captcha_error', "The answer provided is not correct. Please try again.");
	...
	function captcha_configure(){
		...
		$main_smarty->assign('q_1_low', $q_1_low);
		$main_smarty->assign('q_1_high', $q_1_high);
		$main_smarty->assign('q_2_low', $q_2_low);
		$main_smarty->assign('q_2_high', $q_2_high);
