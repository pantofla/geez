...
<p align="right"><input type="submit" value="{#PLIGG_Admin_Snippet_Add_New#}" onclick="document.location='?module=admin_snippet&mode=new'; return false;" class="log2" /> <input type="submit" name="update" value="{#PLIGG_Admin_Snippet_Update#}" class="log2" /> <input type="submit" name="delete" value="{#PLIGG_Admin_Snippet_Delete_Selected#}" class="log2" /></p>
</form>
