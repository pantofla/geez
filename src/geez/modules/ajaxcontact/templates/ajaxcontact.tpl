...
{/literal}
	...
	<h2>{#PLIGG_Visual_ajaxcontact#}</h2>
<div class="content">&#928;&#945;&#961;&#945;&#954;&#945;&#955;&#959;&#973;&#956;&#949;, {#PLIGG_Visual_feedbackform#}<a href="http://www.geez.gr/faq.php/">FAQ</a>!	</div>


	
	
	<p id="loadBar" style="display:none;">
		<strong>{#PLIGG_Ajax_Contact_Sending_Email#}</strong> <img src="{$my_base_url}{$my_pligg_base}/modules/ajaxcontact/img/loading.gif" alt="Loading..." title="Sending Email" align="absmiddle" />
		<br /><br />
	</p>
