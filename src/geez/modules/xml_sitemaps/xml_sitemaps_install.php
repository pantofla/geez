...
*/
	...
	$module_info['db_sql'][]="insert into ".table_prefix."config (var_page,var_name,var_value,var_defaultvalue,var_optiontext,var_title,var_desc,var_method) values ('XmlSitemaps','XmlSitemaps_yahoo_key','','','alphanumeric key from yahoo.com','Yahoo siteexplorer key','This key is required if you want to ping yahoo,<br />Don\\'t have one? get it <a href=\"http://developer.yahoo.com/wsregapp/index.php\">here</a>', 'define')";
	}
	...
	$module_info['db_sql'][]="insert into ".table_prefix."config (var_page,var_name,var_value,var_defaultvalue,var_optiontext,var_title,var_desc,var_method) values ('XmlSitemaps','XmlSitemaps_use_cache','false','false','boolean','Use cache','Serve the sitemap from the disk cache, and don\\'t ping any services untill the cache expires','define')";
	}
