...
if(isset($_POST["group_title"]) || isset($_POST["group_description"]) || isset($_POST["group_privacy"])  || isset($_POST["group_vote_to_publish"]))
*/
...
//	global $db,$main_smarty;
	...
	if (!$errors && 
	    $db->query("update ". table_groups ." set group_name = '".$group_title."', group_description = '".$group_description."', group_privacy = '".$group_privacy."', group_vote_to_publish = '".$group_vote_to_publish."' where group_id = '".$requestID."'"))
