...
<form action="{$URL_register}" method="post" id="thisform">
	...
	<span id="checkit-reg-username"><input type="button" name="reg-checkbutton1" id="reg-checkbutton1" value="{#PLIGG_Visual_Register_Verify#}" onclick="checkfield('username', this.form, this.form.reg_username)" class="submit-s searchbutton" tabindex="11" /></span><br/><span id="reg_usernamecheckitvalue"></span>
	...
	<span id="checkit-reg-pass"><input type="button" name="reg-checkbutton2" id="reg-checkbutton2" value="{#PLIGG_Visual_Register_Verify#}" onclick="checkfield('email', this.form, this.form.reg_email)" class="submit-s searchbutton" tabindex="13" /></span><br/><span id="reg_emailcheckitvalue"></span>
	...
	<input type="submit" name="submit" value="{#PLIGG_Visual_Register_Create_User#}" class="log2 searchbutton" tabindex="16" />
