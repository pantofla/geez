...
{checkActionsTpl location="tpl_pligg_story_start"}
	...
	{/if}
		...
		<div class="storycontent">
			...
			{*	<b><img src="http://images.websnapr.com/?url={$url_short}&size=T" style="float:right; width:100px; height:50px; padding:0px 10px 10px 0px"></b>*}

{* <b><a href="{$story_url}"><img src="http://www.shrinktheweb.com/xino.php?embed=1&STWAccessKeyId=de3186041a074b4&Size=lg&stwUrl={$url_short}" border="0" alt="A preview image" style="float:left; width:100px; height:50px; padding:0px 10px 10px 0px"></a></b> *}


<b><a href="{$story_url}"><img src="http://www.shrinktheweb.com/xino.php?embed=1&STWAccessKeyId=796f85f56cc0ed4&Size=lg&stwUrl={$url_short}" border="0" alt="A preview image" style="float:left; width:100px; height:50px; padding:0px 10px 10px 0px"></a></b>
...
*}		
		...
		{checkActionsTpl location="tpl_pligg_story_body_start_full"}{else}{checkActionsTpl location="tpl_pligg_story_body_start"}{/if}
		...
		{if $viewtype neq "short"}
			<span class="news-body-text">
				<span id="ls_contents-{$link_shakebox_index}">
					...
					{if $pagename neq "story" && $pagename neq "submit"}<a href="{$story_url}"><br />{#PLIGG_Visual_Read_More#}</a>&raquo;{/if}
				</span>
			</span>
	...
	<div class="storyfooter">
		...
		<span id="ls_comments_url-{$link_shakebox_index}">
			{if $story_comment_count eq 0}
				<span id="linksummaryDiscuss"><a href="{$story_url}#discuss" class="comments"><img src="{$my_pligg_base}/templates/{$the_template}/images/comment.png"width=10 height=10 border="0";/>{#PLIGG_MiscWords_Discuss#}</a>&nbsp;</span>
			{/if}
		...
		{if $Enable_Recommend eq 1 && $user_logged_in neq ""}
			...
			<span id="ls_recommend-{$link_shakebox_index}">
				<span id="linksummaryTellFriend">
					<a href="javascript://" onclick="show_recommend({$link_shakebox_index}, {$link_id}, '{$instpath}');"> <img src="{$my_pligg_base}/templates/{$the_template}/images/email.png"width=10 height=10 border="0";/>{#PLIGG_Visual_Recommend_Link_Text#}</a>&nbsp;
				</span>
			</span> 
		{/if}		
...
<a href="http://www.addthis.com/bookmark.php?v=20" onmouseover="return addthis_open(this, '', '{/literal}{$my_base_url}{$my_pligg_base}{$story_url}{literal}', '{/literal}{$title_short}{literal}')" onmouseout="addthis_close()" onclick="return addthis_sendto()"><img src="http://s7.addthis.com/static/btn/sm-plus.gif" width="16" height="16" alt="Bookmark and Share" style="border:0"/></a><script type="text/javascript" src="http://s7.addthis.com/js/200/addthis_widget.js"></script>
<!-- AddThis Button END -->
...
{include file=$the_template."/adsense/adstest.tpl"}
