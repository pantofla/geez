...
<div id="logo"><a href="{$my_base_url}{$my_pligg_base}"><img src="{$my_pligg_base}/templates/{$the_template}/images/logomini.png" border="0"; ><a href="{$my_base_url}{$my_pligg_base}"></a></a>                       	             	
...
<!-- START FOOTER -->
		<div id="footer">
      	...
      	<span class="capital">{#PLIGG_Visual_categor#}</span> <br />
	<span class="class1"><a href="/category/I%95I%80I%B9I%BAI%B1I%B9I%81I%8CI%84I%B7I%84I%B1">{#PLIGG_Visual_epikairothta#}</a></span> <br />
	<span class="class1"><a href="/category/I%9FI%B9I%BAI%BFI%BDI%BFI%BCI%AFI%B1">{#PLIGG_Visual_oikonomia#}</a></span> <br />
	<span class="class1"><a href="/category/I%A4I%B5I%87I%BDI%BFI%BBI%BFI%B3I%AFI%B1">{#PLIGG_Visual_texnologia#}</a></span> <br />
	<span class="class1"><a href="/category/I%A0I%BFI%BBI%B9I%84I%B9I%BAI%AE">{#PLIGG_Visual_politikh#}</a></span> <br />
	<span class="class1"><a href="/category/I%95I%80I%B9I%83I%84I%AEI%BCI%B5I%82">{#PLIGG_Visual_episthmes#}</a></span> <br />
	<span class="class1"><a href="/category/I%91I%B8I%BBI%B7I%84I%B9I%BAI%AC">{#PLIGG_Visual_athlitika#}</a></span> <br />
	...
	<span class="class1"><a href="/category/I%A8I%85I%87I%B1I%B3I%89I%B3I%AFI%B1">{#PLIGG_Visual_psixagogia#}</a></span> <br />
	<span class="class1"><a href="/category/I%91I%83I%84I%B5I%AFI%B1">{#PLIGG_Visual_asteia#}</a></span> <br />
      	  ...
      	  <span class="class1">    <a href="http://www.geez.gr/">geez</a><br />
      	     	<a href="http://geez.gr/advancedsearch.php">{#PLIGG_Visual_Search_Advanced#}</a><br />
       		 ...
       		 <a href="http://www.geez.gr/terms.php">{#PLIGG_Visual_termsandconditions#}</a><br />
  		<a href="http://www.geez.gr/module.php?module=ajaxcontact">Support/Problem?</a></span><br />
        </div>
 
        	<div class="bottomleft">
           	      	<span class="capital"> geez</span> <br />
    <span class="class1"> <a href="http://geez.gr/about_us.php">{#PLIGG_Visual_aboutusfooter#}</a><br />
           <a href="http://geez.gr/tour.php">Take the geez Tour</a><br />
           <a href="http://www.geez.gr/module.php?module=ajaxcontact">{#PLIGG_Visual_contactusfooter#}</a><br />
...
{/literal}
   	 {literal}<script src="http://static.crowdscience.com/start.js?id=3f5dd285d4"></script> {/literal}
