{if $isAdmin eq 1}
	{php}
		...
		if($canIhaveAccess == 1)
		{
			...
			echo "<fieldset><legend><img src=".my_pligg_base."/templates/admin/images/manage_backup.gif align=absmiddle /> ";{/php}{#PLIGG_Visual_AdminPanel_Backup#}{php}echo "</legend>";
