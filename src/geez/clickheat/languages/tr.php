...
define('LANG_JAVASCRIPT_GROUP2', 'sayfa başlığı kullan (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">önerilmez</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'site adresi kullan (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">önerilmez</a>)');
...
define('LANG_CONFIG_MEMORY', 'Hafıza sınırı (varsayılan php.ini değeri: %dMB, sınırlar: %d dan %dMB a kadar, fakat <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">yüksek değerlere dikkat edin.</a>)');
