...
define('LANG_LATEST_KO', 'No se encuentra automáticamente la última versión disponible, la suya es %s, la última leída en la web de Labsmedia es');
...
define('LANG_JAVASCRIPT_GROUP2', 'Usar un título para la página (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">no recomendado</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'Usar la dirección de la página web (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">no recomendado</a>)');
...
define('LANG_CONFIG_MEMORY', 'Límite de memoria (valor de php.ini por defecto: %dMB, límites: de %d a %dMB, pero <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">tenga cuidado con valores altos</a>)');
