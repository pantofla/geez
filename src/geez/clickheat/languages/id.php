...
define('LANG_JAVASCRIPT_GROUP2', 'pergunakan judul halaman web (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">tidak direkomendasikan</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'pergunakan URL halaman web (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">tidak direkomendasikan</a>)');
...
define('LANG_CONFIG_MEMORY', 'Batas memori (Nilai bawaaan php.ini: %dMB, batas: dari %d ke %dMB, tapi <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">hati-hati dengan nilai tinggi</a>)');
