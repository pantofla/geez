...
define('LANG_JAVASCRIPT_GROUP2', '使用页面标题 (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">不推荐</a>)');
define('LANG_JAVASCRIPT_GROUP3', '使用页面URL (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">不推荐</a>)');
...
define('LANG_CONFIG_MEMORY', '内存限制(php.ini默认值: %dMB, 大小限制: 从 %d 到 %dMB, 但<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">请小心使用较大的内存设置</a>)');
