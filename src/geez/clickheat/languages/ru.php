...
define('LANG_LATEST_KO', 'Невозможно динамически найти новую версию, Ваша версия: %s, а самая последняя, полученная непосредственно с сайта Labsmedia, - это'); 
...
define('LANG_JAVASCRIPT_GROUP2', 'использовать заголовок страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">не рекомендуется</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'использовать адрес страницы (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">не рекомендуется</a>)');
...
define('LANG_CONFIG_MEMORY', 'Лимит памяти (по умолчанию в php.ini установлено: %dМБ, в пределах от %dМБ до %dМБ, но <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">будьте осторожны с большими значениями</a>)');
