...
define('LANG_CONFIG_MEMORY', 'Ліміт пам\'яті (по замовчуванню в php.ini встановлено: %dМБ, ліміт від %dМБ до %dМБ, але <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">будьте обережними з великими значеннями</a>)');
