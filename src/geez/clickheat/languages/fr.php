...
define('LANG_JAVASCRIPT_GROUP2', 'utiliser le titre de la page (<a href="http://www.labsmedia.fr/clickheat/performance.html" target="_blank">vivement déconseillé</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'utiliser l\'adresse de la page (<a href="http://www.labsmedia.fr/clickheat/performance.html" target="_blank">vivement déconseillé</a>)');
...
define('LANG_CONFIG_MEMORY', 'Limite mémoire (valeur par défaut du php.ini : %dMo, limites : de %d à %dMo, mais <a href="http://www.labsmedia.fr/clickheat/performance.html" target="_blank">attention aux grandes valeurs</a>)');
