...
define('LANG_JAVASCRIPT_GROUP2', 'użyj tytułu strony (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">nie zalecane</a>)');
define('LANG_JAVASCRIPT_GROUP3', 'użyj adresu strony (<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">nie zalecane</a>)');
...
define('LANG_CONFIG_MEMORY', 'Ograniczenie pamięci (domyślnia wartość w php.ini: %dMB, limity: od %d do %dMB, ale <a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">bądź ostrożny z wysokimi wartościami</a>)');
