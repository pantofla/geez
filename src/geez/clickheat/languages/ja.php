...
define('LANG_JAVASCRIPT_GROUP2', 'ページのタイトルを使用（<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">非推奨</a>）');
define('LANG_JAVASCRIPT_GROUP3', 'ウェブページのアドレスを使用：（<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">非推奨</a>）');
...
define('LANG_CONFIG_MEMORY', 'メモリ制限（php.iniのデフォルトは %d MBです。%d ～ %d MBの値で入力してください。）【<a href="http://www.labsmedia.com/clickheat/performance.html" target="_blank">高い設定値には注意が必要です</a>】');
