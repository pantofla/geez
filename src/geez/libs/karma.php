...
$iDaysOfHistoryToUse = 7;
$iPoints_VotesBeforeLinkWentPublished = 3;
$iPoints_VotesAfterLinkWentPublished = 1;
$iPoints_LinksSubmittedButNotPublished = 2;
$iPoints_LinksSubmittedAndPublished = 20;
$iPoints_Comments = 3;
...
foreach($users as $dbuser) {
	...
	$sContributorLines = $sContributorLines . "	<li><a href=\"/user/view/profile/login/$user->username\">$user->username</a>";
	If ($user->url != '') {
