...
if($pligg_category != ''){
	if (urlmethod == 1) {
		$main_smarty->assign('index_url_recent', getmyurl('index_sort', 'recent', '&amp;category='.$pligg_category));
		$main_smarty->assign('index_url_today', getmyurl('index_sort', 'today', '&amp;category='.$pligg_category));
		$main_smarty->assign('index_url_yesterday', getmyurl('index_sort', 'yesterday', '&amp;category='.$pligg_category));
		$main_smarty->assign('index_url_week', getmyurl('index_sort', 'week', '&amp;category='.$pligg_category));
		$main_smarty->assign('index_url_month', getmyurl('index_sort', 'month', '&amp;category='.$pligg_category));
		$main_smarty->assign('index_url_year', getmyurl('index_sort', 'year', '&amp;category='.$pligg_category));
