	...
	function get_group_membered()
	{
		...
		if ($this->group_membered)
			foreach($this->group_membered as $results)
				$output .= "<a href='".my_base_url.my_pligg_base."/group_share.php?link_id=".$this->id."&group_id=".$results->group_id."&user_id=".$current_user->user_id."' >".$results->group_name."</a><br />";
