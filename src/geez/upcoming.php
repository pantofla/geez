...
if(isset($_GET['category'])){
	...
	$main_smarty->assign('upcoming_url_newest', getmyurl('upcoming_sort', 'newest'));
	$main_smarty->assign('upcoming_url_oldest', getmyurl('upcoming_sort', 'oldest'));
	$main_smarty->assign('upcoming_url_mostpopular', getmyurl('upcoming_sort', 'mostpopular'));
	$main_smarty->assign('upcoming_url_leastpopular', getmyurl('upcoming_sort', 'leastpopular'));
}
...
$main_smarty->assign('URL_rss_page', getmyurl('rsspage', $category_data->category__auto_id, 'queued'));
