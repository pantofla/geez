<?php require_once('/home/pantofla/public_html/geez/plugins/modifier.escape.php'); $this->register_modifier("escape", "tpl_modifier_escape");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2009-08-09 11:36:08 CDT */ ?>
...
" />
		...
		<center>
		<input type=button onclick="javascript:gPageIsOkToExit=true;window.history.go(-1);" value="<?php echo $this->_confs['PLIGG_Visual_Submit3_Modify']; ?>
" class="log2">&nbsp;&nbsp;
		<input type="button" onclick="javascript:submitEdgeStory();" value="<?php echo $this->_confs['PLIGG_Visual_Submit3_SubmitStory']; ?>
" class="submit" />
		</center>
