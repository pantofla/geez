<?php require_once('/home/pantofla/public_html/geez/plugins/function.checkActionsTpl.php'); $this->register_function("checkActionsTpl", "tpl_function_checkActionsTpl");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2009-08-09 07:16:11 CDT */ ?>
...
" align="absmiddle"/><br /><?php endif; ?>      
 ...
 <?php if ($this->_vars['is_anonymous']): ?><b>Unregistered</b><?php endif; ?> <span style="text-transform:capitalize"><a href="<?php echo $this->_vars['user_view_url']; ?>
...
" class="log2" />
					...
					<input type="hidden" name="randkey" value="<?php echo $this->_vars['rand']; ?>
" />
					<input type="hidden" name="link_id" value="<?php echo $this->_vars['comment_link']; ?>
" />
					<input type="hidden" name="comment_parent_id" value="<?php echo $this->_vars['comment_id']; ?>
" />
					<input type="hidden" name="user_id" value="<?php echo $this->_vars['current_userid']; ?>
" />
				</form>	
			</fieldset>
		</div>
